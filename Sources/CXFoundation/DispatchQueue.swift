...
private extension DispatchTimeInterval {
    var nanoseconds: Int {
        ...
        @unknown default:
            ...
            return Int((now + self).rawValue - now.rawValue)
        }
    }
}

// This is Strideable except: <rdar://problem/35158274>
private extension DispatchTime /* : Strideable */ {
...
extension DispatchQueue: CombineX.Scheduler {
    ...
    public struct SchedulerTimeType: Strideable, Codable, Hashable {
        ...
        public struct Stride: CombineX.SchedulerTimeIntervalConvertible, Comparable, SignedNumeric, ExpressibleByFloatLiteral, Hashable, Codable {
    ...
    public func schedule(options: SchedulerOptions?, _ action: @escaping () -> Void) {
        ...
        if let group = options?.group {
            ...
            self.base.async(group: group, qos: qos, flags: flags, execute: action)
        } else {
            self.base.async(qos: qos, flags: flags, execute: action)
        }
    }
    ...
    public func schedule(after date: SchedulerTimeType,
        ...
        self.base.asyncAfter(deadline: date.dispatchTime, qos: qos, flags: flags, execute: action)
    }
    ...
    public func schedule(after date: SchedulerTimeType,
        ...
        let source = DispatchSource.makeTimerSource(flags: DispatchSource.TimerFlags(), queue: self.base)
